    ...
    columns: [
      {
        ...
        links: [
          { label: "HydraFacial", href: `${BASE}/services/hydrafacial-karur` },
          { label: "Hydra Touch", href: `${BASE}/services/hydra-touch-karur` },
          { label: "Laser Toning", href: `${BASE}/services/laser-toning-karur` },
          { label: "Chemical Peels", href: `${BASE}/services/chemical-peel-karur` },
          { label: "Microdermabrasion & Microneedling", href: `${BASE}/services/microdermabrasion-karur` },
          { label: "IV Glutathione Therapy", href: `${BASE}/services/iv-glutathione-karur` },
          { label: "Skin Boosters, PDRN & Exosomes", href: `${BASE}/services/skin-boosters-karur` },
          { label: "Dr. Platon Cold Plasma", href: `${BASE}/services/cold-plasma-karur` },
        ],
      },
      {
    ...
    cards: [
      {
        ...
        ctaHref: `${BASE}/services/hydrafacial-karur`,
      ...
      },
      {
        ...
        ctaHref: `${BASE}/services/hydra-touch-karur`,
      ...
      },
      {
        ...
        ctaHref: `${BASE}/services/laser-toning-karur`,
      ...
      },
      {
        ...
        ctaHref: `${BASE}/services/microdermabrasion-karur`,
      ...
      },
      {
        ...
        ctaHref: `${BASE}/services/iv-glutathione-karur`,
      ...
      },
      {
        ...
        ctaHref: `${BASE}/services/cold-plasma-karur`,
